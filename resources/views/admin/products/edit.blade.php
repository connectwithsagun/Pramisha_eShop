...
<div class="az-content az-content-dashboard">
    <div class="container">
      <div class="az-content-body">
        ...
        <form action="{{ url('/editProduct/'.$products -> id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            Product Name: <input type="text" name="product_name" id="" class="form-control" value="{{ old('product_name') ?? $products->product_name }}"
            @error('product_name')
            ...
            style="border-color: red;"
            @enderror
            >{{ old('product_desc') ?? $products->product_desc }}</textarea> <br><br>

            Old Price: <input type="text" name="old_price" id="" class="form-control" value="{{ old('old_price') ?? $products->old_price }}"
            @error('old_price')
            style="border-color: red;"
            @enderror
            ><br><br>

            Discount: <input type="text" name="discount" id="" class="form-control" value="{{ old('discount') ?? $products->discount }}"
            @error('discount')
            style="border-color: red;"
            @enderror
            ><br><br>
            ...
            Price: <input type="text" name="price" id="" class="form-control" value="{{ old('price') ?? $products->price  }}"
            @error('price')
            style="border-color: red;"
            @enderror
            ><br><br>
